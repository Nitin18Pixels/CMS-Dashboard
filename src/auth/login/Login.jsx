...
const Login = () => {
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center bg-gray-800">
        <div 
      ...
      <div className="flex items-center justify-center w-full lg:w-1/2 p-4 sm:p-8">
        <div className="w-full max-w-md bg-white rounded-xl shadow-md overflow-hidden p-8 sm:p-10">
